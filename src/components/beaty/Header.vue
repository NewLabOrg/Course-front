<template>
    <div class="container mx-auto my-6 font-montserrat flex justify-between border-b">
        ...
        <div class="hidden sm:flex my-4 justify-between">
            ...
            <div class="cursor-pointer z-50" v-if="!isAuth" @click="visible = !visible">
    ...
    <transition name="fade" appear>
        <div v-if="visible" class="absolute z-50 w-full bg-white shadow-md rounded-lg p-4 transition-all duration-500 ease-in-out sm:hidden">
